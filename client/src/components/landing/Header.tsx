    ...
    <header
      ...
      <nav className="max-w-screen-xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <Link to="/about" className="font-medium text-gray-600 hover:text-jive-teal">About Us</Link>
          <Link to="/contact" className="font-medium text-gray-600 hover:text-jive-teal">Contact Us</Link>
        </div>
        <div className="flex items-center space-x-4">
            ...
            <Button className="bg-jive-teal hover:bg-jive-teal/90 text-white" asChild>
                <Link to="/signup">Try Now $79/yr</Link>
            </Button>
        </div>
      </nav>
    </header>
