...
const DigitalPlayshelf = () => {
  ...
  return (
    <div className="min-h-dvh w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-4 sm:pt-6 md:pt-2 pb-4 sm:pb-6 md:pb-8 relative gap-y-12 sm:gap-y-8">
